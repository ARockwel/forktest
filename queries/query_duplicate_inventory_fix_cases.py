...
def run(df: dict | None = None) -> QueryResult:
    ...
    try:
        ...
        # Inject MAXINVID as a VALUES CTE when df is provided (parallel execution path).
        # Without df the query falls back to reading the live #MaxInvID session temp table.
